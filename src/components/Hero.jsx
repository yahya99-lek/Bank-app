      ...
      <div className={` flex-1 ${styles.flexStart}
       flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        bg-discount-gradient rounded-[10px] mb-2">
            <img src={discount} alt="discount" className="w-[32x] h-[32px]" />
        ...
        <h1 className='font-poppins font-semibold
         ...
         text-white ss:leading-[100px] leading-[75px] w-full'>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam facilis deleniti quasi dicta veritatis. Praesentium, velit placeat, quidem corrupti inventore debitis unde officiis, harum earum ut facilis ab a et.</p>
       </div>
       ...
       <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className='absolute z-[] w-[80%] h-[80%]
