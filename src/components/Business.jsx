  ...
  return (
    <section id="features" className={layout.section}>
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} maz-w-[470px] mt-5`}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eligendi laboriosam, doloremque eum ipsam iusto nemo omnis et asperiores quo voluptates? Nihil quam et molestiae quibusdam earum rem sit error assumenda.</p>
        <Button styles="mt-10"/>
      </div>
